...
An open-source desktop GUI for [ani-cli](https://github.com/pystardust/ani-cli).
...
[`LICENSE`](LICENSE) and the bundled upstream license at
[`ani-cli/LICENSE`](ani-cli/LICENSE).
...
restrictions. You are responsible for using the software lawfully and for
respecting copyright and service terms in your location.
